...
abstract class LtoBigViewHolder : EpoxyModelWithHolder<LtoBigViewHolder.Holder>() {
    ...
    @EpoxyAttribute
    lateinit var entity: LtoBigEntity
    ...
    override fun bind(holder: Holder) {
        ...
        fun bindOrderItem(holder: Holder) {
            ...
            for (index in Constants.LTO_BIG_MIN..Constants.LTO_BIG_MAX) {
                val item =
                    entity.column1[getIndexBySortingType(index, sortingType) - Constants.LTO_BIG_MIN]
